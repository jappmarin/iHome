...
CREATE TABLE `booking` (
  ...
  KEY `cur_id_booking_idx` (`customer_id`),
  CONSTRAINT `cur_id_booking` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer` VALUES (1,'parima','2','Parima','Pirin',NULL,'1996-07-17',NULL,NULL,'parima2008@gmail.com','0945464678','Customer'),(2,'japp','33','teera','wut',NULL,NULL,NULL,NULL,'ee@hi','022334342','customer'),(4,'gnn','11','jonn','gnn',NULL,'2017-04-23',NULL,NULL,'dd@johj','0899700899','Guest');
...
INSERT INTO `homestay` VALUES (1,'homme','aaa','aaaa','aaaa','aaaa','aaa',1);
...
CREATE TABLE `host_homestay` (
  ...
  KEY `cus_id_host_idx` (`customer_id`),
  CONSTRAINT `cus_id_host` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `host_homestay` VALUES (1,'weer@gfgg',2),(5,'weer@gfgg',2),(1221,'weer@gfgg',2);
...
CREATE TABLE `review` (
  ...
  UNIQUE KEY `hs_id_UNIQUE` (`hs_id`),
  CONSTRAINT `cus_id_rev` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `hos_id_rev` FOREIGN KEY (`hs_id`) REFERENCES `homestay` (`hs_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-04-13 17:19:27
