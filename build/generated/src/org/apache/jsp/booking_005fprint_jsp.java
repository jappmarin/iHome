...
public final class booking_005fprint_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Homestay homestay = (Homestay) request.getAttribute("homestay");
      ...
      out.write("                            <p class=\"card-text\">Booking Number : <small class=\"text-muted\">");
      out.print(request.getAttribute("booking_id"));
      out.write("</small></p>\n");
      ...
      out.write("                        <div class=\"card-block\">\n");
      out.write("                            <p class=\"card-text\">Homestay Name : <small class=\"text-muted\">");
      ...
      out.write("                            <p class=\"card-text\">Checkin : <small class=\"text-muted\">");
      out.print(request.getAttribute("check_in"));
      out.write("</small></p>\n");
      out.write("                            <p class=\"card-text\">Checkout : <small class=\"text-muted\">");
      out.print(request.getAttribute("check_out"));
      out.write("</small></p>\n");
      out.write("                            <p class=\"card-text\">Room Price : <small class=\"text-muted\">");
